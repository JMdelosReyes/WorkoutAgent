...
class BottomNavigationTrainerActivity : BaseActivity(), AppBarConfiguration.OnNavigateUpListener {
    ...
    companion object {
        fun getLaunchIntent(from: Context) =
            Intent(from, BottomNavigationTrainerActivity::class.java).apply {

...
class ListHistoricActivitiesFragment : Fragment() {
    ...
    private val routineId by lazy { ListHistoricActivitiesFragmentArgs.fromBundle(
        requireArguments()
    ).routineId}
    private val numDay by lazy { ListHistoricActivitiesFragmentArgs.fromBundle(
        requireArguments()
    ).numDay}
    private val nameDay by lazy { ListHistoricActivitiesFragmentArgs.fromBundle(
        requireArguments()
    ).nameDay}

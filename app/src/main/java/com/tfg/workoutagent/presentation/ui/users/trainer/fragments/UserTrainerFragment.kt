...
import com.tfg.workoutagent.presentation.ui.users.trainer.viewModels.UserTrainerViewModel
...
class UserTrainerFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        viewModel =
            ViewModelProvider(this@UserTrainerFragment).get(UserTrainerViewModel::class.java)

...
import com.tfg.workoutagent.presentation.ui.routines.customer.fragments.ListHistoricRoutinesCustomerFragmentArgs
...
class ListHistoricRoutinesCustomerFragment : Fragment() {
    ...
    private val customerId by lazy { ListHistoricRoutinesCustomerFragmentArgs.fromBundle(
        requireArguments()
    ).customerId}

...
class ListHistoricActivitiesAdapter(private val context: Context) : RecyclerView.Adapter<ListHistoricActivitiesAdapter.ListHistoricActivitiesViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ListHistoricActivitiesViewHolder, position: Int) {
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): ListHistoricActivitiesViewHolder {
        val view = LayoutInflater.from(context)
            .inflate(R.layout.item_row_routine_activity_historic, parent, false)
        return ListHistoricActivitiesViewHolder(view)
    }

    override fun getItemCount(): Int = dataList.size

    inner class ListHistoricActivitiesViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
